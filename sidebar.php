<div class="side">
    ...
    <section class="block recent-post">
    ...
    <section class="block">
        <p class="ui <?php $this->options->singleColor() ?> ribbon label"><?php _e('分类'); ?></p>
    ...
    <section class="block">
        <p class="ui <?php $this->options->singleColor() ?> ribbon label"><?php _e('归档'); ?></p>
    ...
    <section class="block">
        <p class="ui <?php $this->options->singleColor() ?> ribbon label"><?php _e('其它'); ?></p>
        <div class="animated list">
